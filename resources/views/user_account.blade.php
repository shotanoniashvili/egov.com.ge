        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 mb-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link{{ Request::is('my-account/uploaded') ? ' text-primary' : '' }}" href="#">ატვირთული პროექტები</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link{{ Request::is('my-account/upload') ? ' text-primary' : '' }}" href="#">პროექტის ატვირთვა</a>
                    </li>
                </ul>
            </div>
