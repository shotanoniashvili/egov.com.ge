...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ URL::to('admin/faq') }}"> <i class="livicon" data-name="bulb" data-size="16" data-color="#000"></i>
                    კითხვა-პასუხიები
                </a>
            </li>
            <li class="active">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('url' => URL::to('admin/faq'), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                        <div class="form-group row {{ $errors->first('question', 'has-error') }}">
                            <label for="question" class="col-sm-4 control-label text-right">
                                კითხვა
                            </label>
                            <div class="col-sm-4">
                                {!! Form::text('question', old('question'), array('id' => 'question', 'class' => 'form-control', 'placeholder'=>'კითხვა')) !!}
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row {{ $errors->first('answer', 'has-error') }}">
                            ...
                            <div class="col-sm-4">
                                <textarea id="answer" name="answer" class="form-control required">{{ old('answer') }}</textarea>
                            </div>
                            <div class="col-sm-4">
