<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! Request::is('admin/project*') ? 'class="active"' : '' !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/projects') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/projects') }}">
                    <i class="fa fa-angle-double-right"></i>
                    პროექტების სია
                </a>
            </li>
            <li {!! (Request::is('admin/projects/archive') ? 'class="active" id="active"' : '') !!}>
            ...
            <li {!! (Request::is('admin/project-categories') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/project-categories') }}">
                    <i class="fa fa-angle-double-right"></i>
                    კატეგორიები
                </a>
            </li>
    ...
    <li {!! (Request::is('admin/municipalities*')) ? 'class="active"' : '' !!}>
        <a href="#">
            <i class="livicon" data-name="bulb" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
               data-loop="true"></i> მუნიციპალიტეტები
            <span class="fa arrow"></span>
        </a>
        <ul class="sub-menu">
            <li {!! (Request::is('admin/municipalities') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/municipalities') }}">
                    <i class="fa fa-angle-double-right"></i>
                    სია
                </a>
            </li>
