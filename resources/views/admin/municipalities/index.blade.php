...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"> მუნიციპალიტეტები</a></li>
        </ol>
    </section>
                ...
                <div class="card ">
                    ...
                    <span class="float-left"> <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                        ...
                        <div class="float-right">
                            <a href="{{ URL::to('admin/municipalities/create') }}" class="btn btn-sm btn-light"><span class="fa fa-plus"></span> დამატება</a>
                        </div>
                    </div>
                    <br />
                    <div class="card-body">
                                    ...
                                    @foreach ($municipalities as $municipality)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($municipality->projects()->count())
                                                    <a href="#" data-toggle="modal" data-target="#blogcategory_exists" data-name="{!! $municipality->name !!}" class="blogcategory_exists">
                                                        <i class="livicon" data-name="warning-alt" data-size="18"
                                                           data-loop="true" data-c="#f56954" data-hc="#f56954"
                                                           title="მუნიციპალიტეტში პროექტები უკვე არსებობს"></i>
                                                    </a>
                                                @else
                                                    <a href="{{ route('admin.municipalities.confirm-delete', $municipality->id) }}" data-toggle="modal" data-id="{{ $municipality->id }}" data-target="#delete_confirm">
...
@section('footer_scripts')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteLabel">მუნიციპალიტეტის წაშლა</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    დარწმუნებული ხართ ხომ გსურთ წაშალოთ მუნიციპალიტეტი?
                </div>
    ...
    <div class="modal fade" id="blogcategory_exists" tabindex="-2" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">მუნიციპალიტეტის წაშლა</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

                </div>
                <div class="modal-body">
                    მუნიციპალიტეტი უკვე მოიცავს ერთ ან რამდენიმე პროექტს
                </div>
            </div>
        </div>
    </div>
    <script>
        ...
        $('#delete_confirm').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer a').prop("href",$url_path+"/admin/municipalities/"+$recipient+"/delete");
        })
    </script>
@stop
