...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ URL::to('admin/regions') }}"> <i class="livicon" data-name="bulb" data-size="16" data-color="#000"></i>
                    რეგიონები
                </a>
            </li>
            <li class="active">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('url' => URL::to('admin/regions'), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
