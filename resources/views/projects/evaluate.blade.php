                                ...
                                @if($subCriteria->isNumberFormat)
                                    ...
                                    <div class="subcriteria-value mt-1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="yes_no{{$subCriteria->id}}" id="sub_yes{{$subCriteria->id}}" type="radio" value="1">
                                            <label class="form-check-label" for="sub_yes{{$subCriteria->id}}">კი</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="yes_no{{$subCriteria->id}}" id="sub_no{{$subCriteria->id}}" type="radio" value="0">
